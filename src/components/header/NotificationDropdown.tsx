            ...
            notifications.map((notif) => (
              <li key={notif.id}>
                <DropdownItem
                  ...
                  className={`flex gap-3 rounded-lg border-b border-gray-100 p-3 px-4.5 py-3 hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-white/5 ${!notif.isRead ? 'bg-orange-50 dark:bg-white/5' : ''}`}
