...
type NavItem = {
  ...
  roles?: ('HR' | 'ADMIN' | 'CANDIDATE')[]; // Role restriction
};
...
const AppSidebar: React.FC = () => {
  ...
  // Determine which navigation to show based on user role and current path
  const getNavItems = (): NavItem[] => {
    const userRole = user?.activeRole?.toUpperCase();
    ...
    // Default: show based on user role
  ...
  const getSectionTitle = () => {
    if (pathname.startsWith('/hr')) return 'Quản lý tuyển dụng';
        ...
        <nav className="mb-6">
          <div className="flex flex-col gap-4">
            <div>
              ...
              >
                {isExpanded || isHovered || isMobileOpen ? getSectionTitle() : <HorizontaLDots />}
              </h2>
