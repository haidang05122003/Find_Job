...
interface Candidate {
  ...
  address?: string;
  experience?: string;
  experiences?: { id: number; companyName: string; position?: string; startDate?: string; endDate?: string }[];
          ...
          <span className="flex items-center gap-1">
            ...
            {candidate.experiences && candidate.experiences.length > 0 ? (
              <span className="truncate max-w-[150px]">
                {candidate.experiences[0].position || candidate.experiences[0].companyName}
                {candidate.experiences.length > 1 && ` (+${candidate.experiences.length - 1})`}
              </span>
