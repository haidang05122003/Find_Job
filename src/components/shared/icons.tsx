...
export const FacebookIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg
    ...
    className={className}
  >
    <path d="M12 2.04C6.48 2.04 2 6.52 2 12.06c0 5.54 4.48 10.02 10 10.02c5.52 0 10-4.48 10-10.02C22 6.52 17.52 2.04 12 2.04zM16.6 8.24h-1.81c-.53 0-.63.25-.63.62v1.03h2.41l-.31 2.48h-2.1v6.31h-2.5V12.37h-2.09V9.89h2.09V8.04c0-2.07 1.26-3.2 3.11-3.2h1.63v2.4z"></path>
  </svg>
);
...
export const GoogleIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
  ...
  >
    ...
    <path
      fill="#FF3D00"
      d="M6.306 14.691c-1.336 2.66-2.136 5.66-2.136 8.869c0 3.209.8 6.209 2.136 8.869l-5.657 5.657C.22 35.39 0 32.25 0 29c0-3.25.22-6.39 1.125-9.35l5.181-5.181z"
    ></path>
    <path
      fill="#4CAF50"
      d="M24 44c5.166 0 9.86-1.977 13.409-5.192l-5.657-5.657C30.01 34.61 27.211 36 24 36c-5.217 0-9.559-3.34-11.303-7.914l-5.657 5.657C9.86 39.023 16.29 44 24 44z"
    ></path>
    <path
      fill="#1976D2"
      d="M43.611 20.083H42V20H24v8h11.303c-0.792 2.237-2.231 4.16-4.087 5.574l5.657 5.657c3.118-2.908 5.127-7.01 5.127-11.829C48 25.125 46.217 22.02 43.611 20.083z"
    ></path>
  </svg>
);
...
export const DollarSignIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const UploadCloudIcon = ({ className = "w-12 h-12" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M21.2 15c.7-1.2 1-2.5.7-3.9-.6-2.4-2.8-4-5.4-4-1.6 0-3.1.8-4.1 2.1-.5-.2-1.1-.3-1.7-.3-2.2 0-4.1 1.8-4.4 4-.3 1.5.1 3 .9 4.2"></path>
    <path d="M7 16l5-5 5 5"></path>
    <path d="M12 11v9"></path>
  </svg>
);

export const FileTextIcon = ({ className = "w-8 h-8" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const TwitterIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M22.46 6c-.77.35-1.6.58-2.46.67.88-.53 1.56-1.37 1.88-2.38-.83.49-1.75.85-2.72 1.05C18.37 4.5 17.26 4 16 4c-2.35 0-4.27 1.92-4.27 4.29 0 .34.04.67.11.98C8.28 9.09 5.11 7.38 3 4.79c-.37.63-.58 1.37-.58 2.15 0 1.49.76 2.8 1.91 3.56-.71 0-1.37-.22-1.95-.54v.05c0 2.08 1.48 3.82 3.44 4.21-.36.1-.74.15-1.13.15-.28 0-.55-.03-.81-.08.55 1.7 2.14 2.94 4.03 2.97-1.47 1.15-3.32 1.83-5.33 1.83-.35 0-.69-.02-1.03-.06 1.9 1.22 4.16 1.93 6.58 1.93 7.89 0 12.21-6.54 12.21-12.21 0-.19 0-.37-.01-.56.84-.6 1.56-1.36 2.14-2.22z"></path>
  </svg>
);

export const InstagramIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.07 1.646.07 4.85s-.012 3.584-.07 4.85c-.148 3.227-1.669 4.771-4.919 4.919-1.266.058-1.646.07-4.85.07s-3.584-.012-4.85-.07c-3.252-.148-4.771-1.691-4.919-4.919-.058-1.265-.07-1.646-.07-4.85s.012-3.584.07-4.85c.148-3.227 1.669-4.771 4.919-4.919C8.416 2.175 8.796 2.163 12 2.163zm0 1.441c-3.173 0-3.51.01-4.745.068-2.7.123-3.871 1.282-3.994 3.994-.058 1.235-.068 1.571-.068 4.745s.01 3.51.068 4.745c.123 2.711 1.282 3.871 3.994 3.994 1.235.058 1.571.068 4.745.068s3.51-.01 4.745-.068c2.711-.123 3.871-1.282 3.994-3.994.058-1.235.068-1.571.068-4.745s-.01-3.51-.068-4.745c-.123-2.711-1.282-3.871-3.994-3.994C15.51 3.614 15.174 3.604 12 3.604zm0 4.846c-2.404 0-4.35 1.946-4.35 4.35s1.946 4.35 4.35 4.35 4.35-1.946 4.35-4.35-1.946-4.35-4.35-4.35zm0 7.141c-1.54 0-2.791-1.251-2.791-2.791s1.251-2.791 2.791-2.791 2.791 1.251 2.791 2.791-1.251 2.791-2.791 2.791zm5.222-7.51c-.62 0-1.12.5-1.12 1.12s.5 1.12 1.12 1.12 1.12-.5 1.12-1.12-.5-1.12-1.12-1.12z"></path>
  </svg>
);

export const YoutubeIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M21.58 7.19c-.23-.86-.9-1.52-1.76-1.76C18.26 5 12 5 12 5s-6.26 0-7.82.43c-.86.24-1.53.9-1.76 1.76C2 8.75 2 12 2 12s0 3.25.42 4.81c.23.86.9 1.52 1.76 1.76C5.74 19 12 19 12 19s6.26 0 7.82-.43c.86-.24 1.53-.9 1.76-1.76C22 15.25 22 12 22 12s0-3.25-.42-4.81zM9.75 15.02V8.98L15.46 12 9.75 15.02z"></path>
  </svg>
);
