                                ...
                                {candidate.socialLinks && candidate.socialLinks.length > 0 ? candidate.socialLinks.map((link) => {
                                    const getSocialIcon = (url: string) => {
                                        ...
                                        if (lowerUrl.includes('instagram')) {
                                            return (
                                                <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11.996 11.996a4 4 0 1 1 0-8 4 4 0 0 1 0 8zm0 12c4.417 0 8-3.582 8-8s-3.583-8-8-8-8 3.582-8 8 3.583 8 8 8zm9-3c0 5.522-4.477 10-10 10s-10-4.478-10-10 4.477-10 10-10 10 4.478 10 10z" />
                                                </svg>
                                            );
                                        }
                                        // Default link icon
                                    ...
                                    return (
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noreferrer"
                                            className="group relative flex h-11 w-11 items-center justify-center rounded-lg border border-gray-200 bg-white text-gray-500 transition-all duration-200 hover:-translate-y-1 hover:border-brand-500 hover:bg-brand-50 hover:text-brand-600 hover:shadow-md dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:border-brand-500 dark:hover:bg-brand-900/30"
                                            title={link.platform || link.url}
                                        >
                                            {getSocialIcon(link.url || link.platform || '')}
                                        </a>
                                    );
